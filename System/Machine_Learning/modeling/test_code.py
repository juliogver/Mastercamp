...
clf_lr = pickle.load(
    open('./System/Machine_Learning/ia_models/logistic_regression_model4.pkl', 'rb'))

# Load the Neural Network model
clf_nn = load_model('./System/Machine_Learning/ia_models/neural_network_model4.h5')
...
# Load the CSV file
df = pd.read_csv('./System/Datas/test_out_out.csv')
...
df.to_csv('./System/trainings outputs/train_test_test.csv', index=False)
