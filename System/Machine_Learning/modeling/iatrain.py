...
import os
os.environ['SSL_CERT_FILE'] = './System/Machine_Learning/modeling/cacert.pem'

nltk.download('stopwords')
nltk.download('wordnet')

# Load the dataset
df = pd.read_csv('.System/Datas/dat_out.csv')
...
# Save the vectorizer
pickle.dump(vectorizer, open('./System/Machine_Learning/ia_models/tfidf_vectorizer.pkl', 'wb'))
...
pickle.dump(clf_lr, open('./System/Machine_Learning/ia_models/logistic_regression_model.pkl', 'wb'))
