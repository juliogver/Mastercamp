...
clf_nn = load_model('./System/Machine_Learning//ia/ia_models/neural_network_model4.h5')

# Load the vectorizer
vectorizer = pickle.load(open('./System/Machine_Learning//ia/ia_models/tfidf_vectorizer.pkl', 'rb'))
