      ...
      <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
        <div class="mx-auto max-w-3xl text-center">
          ...
          <div class="mt-8 flex flex-wrap justify-center gap-4">
            ...
            <button @click="uploadCSV" class="block w-full rounded border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-white focus:outline-none focus:ring active:text-opacity-75 sm:w-auto">Upload CSV</button>
            <button @click="analyzeComments" class="block w-full rounded border border-blue-600 px-12 py-3 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto">Analyze Comments</button>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      analyzeComments() {
        ...
        if (file) {
          ...
          reader.onload = (e) => {
            ...
            const sentimentData = this.analyzeSentiment(contents);
      ...
      analyzeSentiment(csvContent) {
        ...
        // Perform sentiment analysis on comments and return the data
